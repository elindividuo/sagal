...
public class CowDaoAdapter {
	...
	private static final String[] columns = {KEY_ID,KEY_NAME,KEY_BREED, KEY_BIRTH, KEY_TATTOO, KEY_PROBLEMS, KEY_FINAL,KEY_LOCOMOTION,KEY_MOTHER,KEY_FATHER,KEY_FARM};
	
	private static final String COW_CREATE_TABLE = "CREATE TABLE IF NO EXISTS "+ DATABASE_TABLE+" ("+
	...
	public long createCow(int id, String name, String breed, Date birth, String tattoo, String problems, String finalDestination, int locomotion,int motherId, int fatherId , int farmId) throws SQLException{
	...
	public void updateCow(int id, String name, String breed, Date birth, String tattoo, String problems, String finalDestination, int locomotion,int motherId, int fatherId , int farmId) throws SQLException{
		ContentValues cv = new ContentValues();
		cv.put(KEY_ID, id);
		cv.put(KEY_NAME, name);
		cv.put(KEY_BREED, breed);
